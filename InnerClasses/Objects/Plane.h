...
class Plane : public RenderObject {
    ...
    void update_plane(std::vector < eng::Vec3 > points) {
        eng::Vec3 center = (points[0] + points[1] + points[2]) / 3;
    ...
    void update_perpendicular_to_plane(std::pair < int, int > line, std::pair < int, int > plane) {
        ...
        eng::Vec3 horizont = plane_cur.get_normal();
    ...
    void update_bisector(std::pair < int, int > plane1, std::pair < int, int > plane2) {
        ...
        eng::Vec3 direction1 = plane_cur1.get_normal() ^ intersection.get_direction();
        eng::Vec3 direction2 = plane_cur2.get_normal() ^ intersection.get_direction();
